...
export const Card  = () => {
    ...
    return (
              ...
              <a href="https://perfumall-mv7u.onrender.com/" target='a_blank'><img width="95%" className='photo' src="../../image4.png" /></a>
                <h3 className='parraf'><a href="https://perfumall-mv7u.onrender.com/" target='a_blank' className='letter'>Perfumall</a></h3>
              ...
              <a href="https://dashboard-tmwc.onrender.com" target='a_blank'><img width="95%" className='photo' src="../../image2.png" /></a>
                <h3 className='parraf'><a href="https://dashboard-tmwc.onrender.com" target='a_blank' className='letter'>Dashboard of Perfumall.</a></h3>
               
              </Carousel.Item>
              <Carousel.Item>
              <img width="95%" className='photo' src="../../api.png" />
              <h3 className='parraf'><a href="https://github.com/manuelurruti/API-perfumall" target='a_blank' className='letter'>API of Perfumall.</a></h3>
              ...
              <h3 className='parraf'><a href="https://veganprxjxt.onrender.com/" target='a_blank' className='letter'>Vegan proyect</a></h3>
              ...
              <h3 className='parraf'><a href="https://super-biscotti-2b2162.netlify.app/" target='a_blank' className='letter'>League of legends app</a></h3>

              </Carousel.Item>
              <Carousel.Item>
              <a href="https://wheaterapp-efdp.onrender.com/" target='a_blank'><img width="95%" className='photo' src="../../image5.png" /></a>
                <h3 className='parraf'><a href="https://wheaterapp-efdp.onrender.com/" target='a_blank' className='letter'>Weather app</a></h3>
               
                
              </Carousel.Item>
              <Carousel.Item>
              <a href="https://films-1ct6.onrender.com/" target='a_blank'><img width="95%" className='photo' src="../../image6.png" /></a>
              <h3 className='parraf'><a href="https://films-1ct6.onrender.com/" target='a_blank' className='letter'>Films</a></h3>
              ...
              <h3 className='parraf'><a href="https://rikandmortyx.onrender.com/" target='a_blank' className='letter'>Rick & Morty</a></h3>
